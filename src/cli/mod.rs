...
#[derive(Parser, Debug)]
#[command(name = "ironoraclaw")]
#[command(about = "Oracle AI Database-powered secure personal AI assistant")]
#[command(
    long_about = "IronOraClaw is a secure AI assistant backed by Oracle AI Database. Use 'ironoraclaw <subcommand> --help' for details.\nExamples:\n  ironoraclaw run  # Start the agent\n  ironoraclaw config list  # List configs"
)]
#[command(version)]
